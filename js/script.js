...
async function main() {
  ...
  //Adding an event listener to previous, play and next buttons
  ...
  //Adding an event listener to hamburger icon
  document.querySelector(".hamburger").addEventListener("click", () => {
    document.querySelector(".left").style.left = "0";
  });

  //Adding an event listener to close icon
  ...
  //Adding an event listener to mute song
